...
const sections = computed(() => [
  { href: `/${routeLocale.value}/info/links`, emoji: '🔗', label: t('info.links') },
  { href: `/${routeLocale.value}/info/live`, emoji: '📡', label: t('info.live') },
]);
...
<template>
  <div class="space-y-6">
    <h1 class="font-heading text-3xl font-bold text-[var(--foreground)]">{{ t('info.title') }}</h1>
